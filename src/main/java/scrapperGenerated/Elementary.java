...
public class Elementary {
    ...
    public String toString() {
        ...
        sb.append(Elementary.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Elementary) == false) {
            return false;
        }
        Elementary rhs = ((Elementary) other);
