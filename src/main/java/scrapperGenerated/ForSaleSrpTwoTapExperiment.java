...
public class ForSaleSrpTwoTapExperiment {
    ...
    public String toString() {
        ...
        sb.append(ForSaleSrpTwoTapExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForSaleSrpTwoTapExperiment) == false) {
            return false;
        }
        ForSaleSrpTwoTapExperiment rhs = ((ForSaleSrpTwoTapExperiment) other);
