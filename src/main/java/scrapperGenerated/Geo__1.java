...
public class Geo__1 {
    ...
    private GeoStatistics__1 geoStatistics;
    @JsonIgnore
    ...
    @JsonProperty("geo_statistics")
    public GeoStatistics__1 getGeoStatistics() {
        return geoStatistics;
    }

    @JsonProperty("geo_statistics")
    public void setGeoStatistics(GeoStatistics__1 geoStatistics) {
    ...
    public String toString() {
        ...
        sb.append(Geo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("city");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Geo__1) == false) {
            return false;
        }
        Geo__1 rhs = ((Geo__1) other);
        return (((((((this.geoStatistics == rhs.geoStatistics)||((this.geoStatistics!= null)&&this.geoStatistics.equals(rhs.geoStatistics)))&&((this.slugId == rhs.slugId)||((this.slugId!= null)&&this.slugId.equals(rhs.slugId))))&&((this.geoType == rhs.geoType)||((this.geoType!= null)&&this.geoType.equals(rhs.geoType))))&&((this.city == rhs.city)||((this.city!= null)&&this.city.equals(rhs.city))))&&((this.stateCode == rhs.stateCode)||((this.stateCode!= null)&&this.stateCode.equals(rhs.stateCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
