...
public class Attributes__3 {
    ...
    public String toString() {
        ...
        sb.append(Attributes__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Attributes__3) == false) {
            return false;
        }
        Attributes__3 rhs = ((Attributes__3) other);
