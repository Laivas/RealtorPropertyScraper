...
public class HowToBuyVideos {
    ...
    public String toString() {
        ...
        sb.append(HowToBuyVideos.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("result");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HowToBuyVideos) == false) {
            return false;
        }
        HowToBuyVideos rhs = ((HowToBuyVideos) other);
