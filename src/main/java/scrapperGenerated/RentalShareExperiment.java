...
public class RentalShareExperiment {
    ...
    public String toString() {
        ...
        sb.append(RentalShareExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RentalShareExperiment) == false) {
            return false;
        }
        RentalShareExperiment rhs = ((RentalShareExperiment) other);
