...
public class OpenRentalLDPInNewTabExperiment {
    ...
    public String toString() {
        ...
        sb.append(OpenRentalLDPInNewTabExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OpenRentalLDPInNewTabExperiment) == false) {
            return false;
        }
        OpenRentalLDPInNewTabExperiment rhs = ((OpenRentalLDPInNewTabExperiment) other);
