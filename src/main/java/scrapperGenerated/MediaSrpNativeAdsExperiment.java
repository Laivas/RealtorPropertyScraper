...
public class MediaSrpNativeAdsExperiment {
    ...
    public String toString() {
        ...
        sb.append(MediaSrpNativeAdsExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MediaSrpNativeAdsExperiment) == false) {
            return false;
        }
        MediaSrpNativeAdsExperiment rhs = ((MediaSrpNativeAdsExperiment) other);
