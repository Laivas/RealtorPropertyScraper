...
public class GeoStatistics__3 {

    @JsonProperty("housing_market")
    private HousingMarket__2 housingMarket;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();

    @JsonProperty("housing_market")
    public HousingMarket__2 getHousingMarket() {
        return housingMarket;
    }

    @JsonProperty("housing_market")
    public void setHousingMarket(HousingMarket__2 housingMarket) {
    ...
    public String toString() {
        ...
        sb.append(GeoStatistics__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeoStatistics__3) == false) {
            return false;
        }
        GeoStatistics__3 rhs = ((GeoStatistics__3) other);
