...
public class TigerMobileExperiment {
    ...
    public String toString() {
        ...
        sb.append(TigerMobileExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TigerMobileExperiment) == false) {
            return false;
        }
        TigerMobileExperiment rhs = ((TigerMobileExperiment) other);
