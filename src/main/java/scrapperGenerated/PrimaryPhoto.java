...
public class PrimaryPhoto {
    ...
    public String toString() {
        ...
        sb.append(PrimaryPhoto.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PrimaryPhoto) == false) {
            return false;
        }
        PrimaryPhoto rhs = ((PrimaryPhoto) other);
