...
public class Flags {
    ...
    @JsonProperty("is_coming_soon")
    public Object getIsComingSoon() {
        return isComingSoon;
    }

    @JsonProperty("is_coming_soon")
    public void setIsComingSoon(Object isComingSoon) {
    ...
    @JsonProperty("is_price_reduced")
    public Boolean getIsPriceReduced() {
        return isPriceReduced;
    }

    @JsonProperty("is_price_reduced")
    public void setIsPriceReduced(Boolean isPriceReduced) {
    ...
    public String toString() {
        ...
        sb.append('=');
        sb.append(((this.isComingSoon == null)?"<null>":this.isComingSoon));
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result* 31)+((this.isComingSoon == null)? 0 :this.isComingSoon.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.isComingSoon == rhs.isComingSoon)||((this.isComingSoon!= null)&&this.isComingSoon.equals(rhs.isComingSoon)))&&((this.isPriceReduced == rhs.isPriceReduced)||((this.isPriceReduced!= null)&&this.isPriceReduced.equals(rhs.isPriceReduced))))&&((this.isForeclosure == rhs.isForeclosure)||((this.isForeclosure!= null)&&this.isForeclosure.equals(rhs.isForeclosure))))&&((this.isNewListing == rhs.isNewListing)||((this.isNewListing!= null)&&this.isNewListing.equals(rhs.isNewListing))))&&((this.isContingent == rhs.isContingent)||((this.isContingent!= null)&&this.isContingent.equals(rhs.isContingent))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.isPending == rhs.isPending)||((this.isPending!= null)&&this.isPending.equals(rhs.isPending))))&&((this.isNewConstruction == rhs.isNewConstruction)||((this.isNewConstruction!= null)&&this.isNewConstruction.equals(rhs.isNewConstruction))));
    }
