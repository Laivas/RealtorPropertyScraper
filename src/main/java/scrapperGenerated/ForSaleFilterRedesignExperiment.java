...
public class ForSaleFilterRedesignExperiment {
    ...
    public String toString() {
        ...
        sb.append(ForSaleFilterRedesignExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ForSaleFilterRedesignExperiment) == false) {
            return false;
        }
        ForSaleFilterRedesignExperiment rhs = ((ForSaleFilterRedesignExperiment) other);
