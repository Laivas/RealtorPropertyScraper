...
public class RentalSaveSearchPromptExperiment {
    ...
    public String toString() {
        ...
        sb.append(RentalSaveSearchPromptExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RentalSaveSearchPromptExperiment) == false) {
            return false;
        }
        RentalSaveSearchPromptExperiment rhs = ((RentalSaveSearchPromptExperiment) other);
        return ((((((this.experimentKey == rhs.experimentKey)||((this.experimentKey!= null)&&this.experimentKey.equals(rhs.experimentKey)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.featureKey == rhs.featureKey)||((this.featureKey!= null)&&this.featureKey.equals(rhs.featureKey))))&&((this.variation == rhs.variation)||((this.variation!= null)&&this.variation.equals(rhs.variation))))&&((this.isEnabled == rhs.isEnabled)||((this.isEnabled!= null)&&this.isEnabled.equals(rhs.isEnabled))));
    }
