...
public class PrimaryPhoto__1 {
    ...
    public String toString() {
        ...
        sb.append(PrimaryPhoto__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("href");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PrimaryPhoto__1) == false) {
            return false;
        }
        PrimaryPhoto__1 rhs = ((PrimaryPhoto__1) other);
