...
public class RentRerankExperiment {
    ...
    public String toString() {
        ...
        sb.append(RentRerankExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RentRerankExperiment) == false) {
            return false;
        }
        RentRerankExperiment rhs = ((RentRerankExperiment) other);
