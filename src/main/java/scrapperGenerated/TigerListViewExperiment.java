...
public class TigerListViewExperiment {
    ...
    public String toString() {
        ...
        sb.append(TigerListViewExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TigerListViewExperiment) == false) {
            return false;
        }
        TigerListViewExperiment rhs = ((TigerListViewExperiment) other);
