...
public class Middle {
    ...
    public String toString() {
        ...
        sb.append(Middle.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Middle) == false) {
            return false;
        }
        Middle rhs = ((Middle) other);
