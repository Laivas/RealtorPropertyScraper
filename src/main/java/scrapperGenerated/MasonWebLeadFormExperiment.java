...
public class MasonWebLeadFormExperiment {
    ...
    public String toString() {
        ...
        sb.append(MasonWebLeadFormExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MasonWebLeadFormExperiment) == false) {
            return false;
        }
        MasonWebLeadFormExperiment rhs = ((MasonWebLeadFormExperiment) other);
