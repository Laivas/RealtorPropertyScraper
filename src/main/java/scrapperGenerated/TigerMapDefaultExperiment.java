...
public class TigerMapDefaultExperiment {
    ...
    public String toString() {
        ...
        sb.append(TigerMapDefaultExperiment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TigerMapDefaultExperiment) == false) {
            return false;
        }
        TigerMapDefaultExperiment rhs = ((TigerMapDefaultExperiment) other);
