...
public class GeoStatistics__2 {

    @JsonProperty("housing_market")
    private HousingMarket__1 housingMarket;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();

    @JsonProperty("housing_market")
    public HousingMarket__1 getHousingMarket() {
        return housingMarket;
    }

    @JsonProperty("housing_market")
    public void setHousingMarket(HousingMarket__1 housingMarket) {
    ...
    public String toString() {
        ...
        sb.append(GeoStatistics__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeoStatistics__2) == false) {
            return false;
        }
        GeoStatistics__2 rhs = ((GeoStatistics__2) other);
