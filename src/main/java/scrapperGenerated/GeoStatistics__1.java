...
public class GeoStatistics__1 {

    @JsonProperty("housing_market")
    private Object housingMarket;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new LinkedHashMap<String, Object>();

    @JsonProperty("housing_market")
    public Object getHousingMarket() {
        return housingMarket;
    }

    @JsonProperty("housing_market")
    public void setHousingMarket(Object housingMarket) {
    ...
    public String toString() {
        ...
        sb.append(GeoStatistics__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeoStatistics__1) == false) {
            return false;
        }
        GeoStatistics__1 rhs = ((GeoStatistics__1) other);
