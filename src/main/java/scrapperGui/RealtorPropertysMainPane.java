...
import scrapperGuiHandlers.RealtorPropertysMainPaneHandler;
import scrapperUtil.Workable;

@Getter
@Setter
public class RealtorPropertysMainPane extends BorderPane implements Workable {
	...
	private RealtorPropertysMainPaneHandler realtorPropertysMainPaneHandler;
	...
	public RealtorPropertysMainPane() {
		
		borderPane = new BorderPane();	
		
		realtorPropertysMainPaneHandler = new RealtorPropertysMainPaneHandler(this);
	...
	public void setHandler() {
		...
		startButton.setOnAction(realtorPropertysMainPaneHandler);
		
		stopButton.setOnAction(realtorPropertysMainPaneHandler);
		
		pauseResumeButton.setOnAction(realtorPropertysMainPaneHandler);
