...
//			pagesRead.add(url);
	...
	public String inputByteArrayToString(byte[] byteArray) {
		
		String content = "";
		
		try {
			GZIPInputStream gzipStream = new GZIPInputStream(new ByteArrayInputStream(byteArray));
			
			BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(gzipStream, "UTF-8"));
