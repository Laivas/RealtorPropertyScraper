...
//			settingsPane.getProxySellerApiTextField().setText(settingsPaneSelection.getProxySellerApiKey());
			...
			settingsPane.getNumberOfThreadsComboBox().getItems().addAll(valuesAsList(Integer.valueOf(settingsPaneSelection.getNumberOfThreads())));
			...
			if(Integer.valueOf(settingsPaneSelection.getAvailableProxyCount()) > 0) {
